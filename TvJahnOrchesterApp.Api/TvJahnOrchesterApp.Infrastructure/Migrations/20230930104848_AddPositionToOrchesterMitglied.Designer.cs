...
namespace TvJahnOrchesterApp.Infrastructure.Migrations
{
    ...
    [Migration("20230930104848_AddPositionToOrchesterMitglied")]
    partial class AddPositionToOrchesterMitglied
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TvJahnOrchesterApp.Domain.OrchesterMitgliedAggregate.OrchesterMitglied", b =>
                {
                    ...
                    b.OwnsMany("TvJahnOrchesterApp.Domain.OrchesterMitgliedAggregate.ValueObjects.Position", "Positions", b1 =>
                        {
                            b1.Property<Guid>("OrchesterMitgliedId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Property<int>("PositionEnum")
                                .HasColumnType("int");

                            b1.HasKey("OrchesterMitgliedId", "Id");
