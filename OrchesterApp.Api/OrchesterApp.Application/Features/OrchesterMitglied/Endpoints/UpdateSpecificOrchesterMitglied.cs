...
namespace TvJahnOrchesterApp.Application.Features.OrchesterMitglied.Endpoints
{
    public static class UpdateSpecificOrchesterMitglied
    {
        ...
        private static async Task<IResult> UpdateSpecificOrchesterMitglieder(
            UpdateSpecificOrchesterMitgliederQuery updateSpecificQuery, ISender sender,
        ...
        private record UpdateSpecificOrchesterMitgliederQuery(
            Guid Id,
            string Straße,
            string Hausnummer,
            string Postleitzahl,
        ...
        private class
            UpdateSpecificOrchesterMitgliederQueryHandler : IRequestHandler<UpdateSpecificOrchesterMitgliederQuery,
            Unit>
        {
            ...
            public UpdateSpecificOrchesterMitgliederQueryHandler(
            ...
            public async Task<Unit> Handle(UpdateSpecificOrchesterMitgliederQuery request,
                CancellationToken cancellationToken)
            {
                ...
                DateTime? geburtstagUtc =
                    request.Geburtstag is null ? null : request.Geburtstag.Value.ToUniversalTime();

                orchesterMitglied.UserUpdates(adresse, geburtstagUtc, request.Telefonnummer, request.Handynummer,
                    imageAsByteArray);
