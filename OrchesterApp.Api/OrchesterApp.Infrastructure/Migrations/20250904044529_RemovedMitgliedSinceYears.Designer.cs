...
namespace OrchesterApp.Infrastructure.Migrations
{
    ...
    [Migration("20250904044529_RemovedMitgliedSinceYears")]
    partial class RemovedMitgliedSinceYears
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrchesterApp.Domain.TerminAggregate.Termin", b =>
                {
                    ...
                    b.OwnsMany("OrchesterApp.Domain.TerminAggregate.TerminDokument", "Dokumente", b1 =>
                        {
                            b1.Property<Guid>("TerminId")
                                .HasColumnType("uuid");
